        ...
        switch(choice) {
            case 1: {
                ...
                if (runType == 1) {
                    ...
                    batsmen[striker].ballsPlayed++; // Increment balls played by the striker
                    ...
                    totalRuns += runs;
                    extras += runs;
                    balls++; // Increment ball count for leg byes
                } else {
            ...
            case 2:
                ...
                if (isFreeHit) {
                    ...
                    // Ask if the batsmen completed any runs by running
                    int runsCompleted;
                    ...
                    // Ask who was run out (striker or non-striker)
                    ...
                    // Mark the appropriate batsman as out
                    if (runOutChoice == 1) {
                        strcpy(batsmen[striker].dismissal, "Run Out");
                        batsmen[striker].isOut = 1;
                        batsmen[striker].ballsPlayed = 0; // Reset balls played by the batsman
                        striker = nextBatsman; // Bring in the next batsman
                        nextBatsman++;
                    } else if (runOutChoice == 2) {
                        strcpy(batsmen[nonStriker].dismissal, "Run Out");
                        batsmen[nonStriker].isOut = 1;
                        batsmen[nonStriker].ballsPlayed = 0; // Reset balls played by the batsman
                        nonStriker = nextBatsman; // Bring in the next batsman
                        nextBatsman++;
                    } else {
                    ...
                    balls++;   // Increment ball count
                    isFreeHit = 0; // Reset free hit flag
                    break;
                }
                
                // Ask how the batsman got out (normal dismissal)
            ...
            case 3:
                ...
                switch(ballType) {
                    case 1:
                        ...
                        break;
                    case 2:
                        // Wide Ball: 1 run added to total and extras, ball is not counted
                        totalRuns += 1;
                        extras += 1;
                        break;
                    case 3:
                        // No Ball: 1 run added to total and extras, ball is not counted, next ball is a free hit
                        totalRuns += 1;
                        extras += 1;
