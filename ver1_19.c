...
int main() {
 ...
 printf("Select overs type:\n1. Unlimited\n2. Defined\nEnter your choice: ");
    ...
    printf("\n%s's Innings:\n", teamOneName);
    playInnings(teamOneBatsmen, teamOneBowlers, &numTeamOneBowlers, maxOvers, 1, teamOneName);

    // Play Team Two's innings
    printf("\n%s's Innings:\n", teamTwoName);
    playInnings(teamTwoBatsmen, teamTwoBowlers, &numTeamTwoBowlers, maxOvers, 2, teamTwoName);
