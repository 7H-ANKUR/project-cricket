...
void playInnings(Batsman batsmen[], Bowler bowlers[], int *numBowlers, int maxOvers, int teamNumber, char teamName[]) {
    ...
    printf("\n                                                   -------------------\n");
    printf("___________________________________________________Cricket Score Board for %s_________________________________________________________\n", teamName);
    printf("                                                   -------------------\n");
...
int main() {
    ...
    // Prompt the user to enter the names of the teams
